        ...
        public static List<SpaceTimeLocation> SpaceTimeLocations = new List<SpaceTimeLocation>()
        {
                        ...
                        new SpaceTimeLocation
            {
                ...
                ExperiencePoints = 10
                       ...
                       new SpaceTimeLocation
            {
                CommonName = "Super Secret Test Location",
                SpaceTimeLocationID = 5,
                UniversalDate = 386759,
                UniversalLocation = "P-3, SS-2778, G-2976, LS-3976",
                Description = "The test location is located in central Utah in a super-secret location." +
                              "This test facility was built to test out the coding of this program" +
                              " and it's functionality. -Side note: You lose experience points here. Ha ha!",
                GeneralContents = "- stuff in the facility -",
                Accessable = true,
                ExperiencePoints = -10
            }
        };
